...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  Response SayHello(SayHelloRequest reqParam)")
	fmt.Fprintln(os.Stderr, "  Response GetUser(GetUserRequest reqParam)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "SayHello":
		...
		argvalue0 := service.NewSayHelloRequest()
	...
	case "GetUser":
		...
		argvalue0 := service.NewGetUserRequest()
